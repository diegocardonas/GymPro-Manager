            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-6 mb-4 md:mb-0">
                        <a href="#" className="text-sm text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
                            Privacy Policy
                        </a>
                        <a href="#" className="text-sm text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
                            Terms of Service
                ...
                <div className="border-t border-gray-100 dark:border-gray-800 mt-6 pt-6 text-center">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        &copy; {currentYear} GymPro Manager. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
